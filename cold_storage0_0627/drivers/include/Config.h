...
extern int  myprintf2(unsigned char uarttype, char *fmt, ...);
extern unsigned char mygetchar(void);
extern void myputchar(unsigned char chr);
extern void myputchar2(unsigned char uarttype, unsigned char chr);

#define log_printf(fmt, args...) 	myprintf(fmt, ##args)
#define log_printf2(chr, fmt, args...) 	    myprintf2(chr, fmt, ##args)
#define log_putchar(chr) 			myputchar(chr)
#define log_putchar2(uart, chr) 			myputchar2(uarttype, chr)
...
#define printf2(chr, fmt, args...) 		    log_printf2(chr, fmt, ##args)
