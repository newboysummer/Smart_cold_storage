/****************************************************************************
** Meta object code from reading C++ file 'sensor_worker.h'
**
...
#include <memory>
#include "../TempHumi/sensor_worker.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'sensor_worker.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 16), // "newDataAvailable"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 13), // "sensor_struct"
QT_MOC_LITERAL(4, 45, 4), // "data"
QT_MOC_LITERAL(5, 50, 6) // "doWork"

    },
    "SensorWorker\0newDataAvailable\0\0"
    "sensor_struct\0data\0doWork"
};
...
void SensorWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newDataAvailable((*reinterpret_cast< const sensor_struct(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SensorWorker::*)(const sensor_struct & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SensorWorker::newDataAvailable)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SensorWorker::newDataAvailable(const sensor_struct & _t1)
{
